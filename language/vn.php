...
define("CART_TONGCONG","Tổng cộng");
define("CART_DEL","Xóa");
define("CART_EMPTY","Hiện chưa có sản phẩm nào trong giỏ hàng");
...
define("NOIDUNGHUONGDANMUAHANG","<p>Vui lòng đưa sản phẩm muốn mua vào giỏ hàng.</p>
...
define("KH_CHUYENKHOAN3","Thanh toán trực tiếp cho nhân viên giao hàng.");
...
define("TUKHOA","Từ khóa tìm kiếm");
