...
?>
	...
	<tr>
		<td><textarea name="description_<?=$vlang ?>" id="des" style="height:150px;width:520px;"></textarea></td>
	</tr>
	<tr>
...
Thông tin thiết lập
	...
	<table class="right_new">
        ...
        <tr>
            ...
            <td><input type = 'text' name = 'sort' size = '50'></td>
        </tr>
        <tr>
            <td class = 'title_td'>Ngày đăng</td>
            <td><input type = 'text' name = 'date' size = '50' value="<?=date("Y-m-d H:i:s") ?>" ></td>
        </tr>
        <tr>
            <td class = 'title_td'>Số lần xem</td>
            <td><input type = 'text' name = 'visit' size = '50' value="50"></td>
        </tr>
        ...
        <tr>
            ...
            <td>
            	<textarea name="meta_keyword" style="width:325px; height:100px;"></textarea>
            </td>
        </tr>
         <tr>
            <td class = 'title_td'>Meta Description</td>
            <td>
            	<textarea name="meta_description" style="width:325px; height:100px;"></textarea>
            </td>
        </tr>
    </table>
</td>
