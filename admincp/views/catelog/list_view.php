		...
		function TreeCatnews($pid,$data,$text=" __ "){
			...
			?>
				<tr>
					...
					<td style="<?=$cls?>" align="left"><a href = '<?php echo BASE_URL_ADMIN;?>catelog/edit/<?php echo $item['id'];?>' title = 'Sửa'><?php echo $text.$item['name']; ?></a></td>
					<td><?=$item['zone'] ?></td>
					<td align = 'center' width="100"><input type = 'text' size = '5' name = 'sort[<?php echo $item['id'];?>]' value = "<?php echo $item['sort_order'];?>" style = '<?=$cls?>text-align:center;' /></td>
                    
                    
                    <td width="70" align = 'center'>
					<?php 
                    if($item['display'] == "1"){
                        echo "<div id = 'display".$item['id']."'><a href = 'javascript: hideshow(\"".TBL_CATELOG."\",\"display\",\"".$item['id']."\",\"0\",\"display".$item['id']."\",\"".BASE_URL_ADMIN."\");' title = 'Bỏ khóa'><img src = '".ADMIN_PATH_IMG."icon-16-default.png'></a></div>";
                    }else{
                        echo "<div id = 'display".$item['id']."'><a href = 'javascript: hideshow(\"".TBL_CATELOG."\",\"display\",\"".$item['id']."\",\"1\",\"display".$item['id']."\",\"".BASE_URL_ADMIN."\");' title = 'Khóa tin'><img src = '".ADMIN_PATH_IMG."icon-16-nondefault.png'></a></div>"; 
                    }
                    ?>
                    </td>
					...
					<td align = 'center' width="50"><a href = '<?php echo BASE_URL_ADMIN;?>catelog/edit/<?php echo $item['id'];?>' title = 'Sửa'><img src = '<?php echo ADMIN_PATH_IMG;?>b_edit.png'></a></td>
